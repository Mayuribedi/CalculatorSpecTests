...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("6", "7", "13", null)]
        [NUnit.Framework.TestCaseAttribute("6", "2", "8", null)]
        public virtual void AddTwoNumbers(string num1, string num2, string sum, string[] exampleTags)
        {
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 4
 testRunner.When(string.Format("i add \'{0}\' and \'{1}\'", num1, num2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 5
